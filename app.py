...
# Reserve the debug panel's spot here at the top, but fill it in *after*
# the submit handler runs so it reflects the latest history.
...
with debug_panel.expander("Developer Debug Info"):
